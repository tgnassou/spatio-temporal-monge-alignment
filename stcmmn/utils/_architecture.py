...
# class AdaptiveShallowFBCSPNet(EEGModuleMixin, nn.Sequential):
...
#         Split first layer into temporal and spatial layers (True)
#         or just use temporal (False).
...
#         pool_class = dict(
#             max=nn.AdaptiveMaxPool2d, mean=nn.AdaptiveAvgPool2d
#         )[self.pool_mode]
...
#         """Wrapper to allow for loading of a state_dict from a model before
#            CombinedConv was implemented"""
#         keys_to_change = [
#             "conv_time.weight",
#             "conv_spat.weight",
#             "conv_time.bias",
